...
InputParameters validParams<ComputeMultiPlasticityStress>()
{
  ...
  //params.addParam<bool>("radial_return_map", false, "Isotropic return-mapping.");
...
ComputeMultiPlasticityStress::ComputeMultiPlasticityStress(const InputParameters & parameters) :
    ...
    //_radial_return_map(getParam<bool>("radial_return_map")),
                                         ...
                                         bool & ld_encountered)
{
  ...
  while (constraints_changing)
  {
   ...
   // if (_radial_return_map)
   // nrStepRR(stress, intnl_old, intnl, pm, E_inv, delta_dp, dstress, dpm, dintnl, active, deact_ld);
