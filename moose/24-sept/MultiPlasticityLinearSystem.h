...
protected:
   ...
   * @param radialReturnMap bool variable stating whether or not radial return map can be used (isotropic elasticity)
   */
  ...
  /*
   * Performs nrStep for special case of isotropic elasticity (radial return mapping)
   */
